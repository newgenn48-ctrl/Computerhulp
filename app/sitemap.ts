...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const basePages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/website-laten-maken`, lastModified: now, changeFrequency: 'yearly', priority: 0.3 },
    { url: `${baseUrl}/offerte-aanvragen`, lastModified: now, changeFrequency: 'yearly', priority: 0.3 },
