...
export const metadata: Metadata = {
  title: 'Student aan Huis Wassenaar | IT-Student Binnen 24u | €14,50',
  description: '🎓 Student aan huis in Wassenaar. Jonge, geduldige IT-studenten binnen 24u bij u thuis! ✓ Computer, laptop, WiFi hulp ✓ Rustig uitleggen ✓ Vanaf €43,50. Bel 06-42548451.',
  openGraph: {
    title: 'Student aan Huis Wassenaar | IT-Studenten Binnen 24u',
    description: 'Jonge, geduldige IT-studenten binnen 24u bij u thuis in Wassenaar. Geduldig uitleggen, rustig helpen. Vanaf €43,50. Bel 06-42548451',
    type: 'website',
  ...
  '@graph': [
    {
      ...
      image: {
        ...
        caption: 'Computerhulp Wassenaar - Student aan Huis'
      },
      address: {
        '@type': 'PostalAddress',
    ...
    },
    {
      ...
      description: 'Computerhulp door jonge IT-studenten aan huis in Wassenaar. Geduldig, betaalbaar en kundig. Perfect voor wie liever met een jongere werkt.',
      url: 'https://computerhulpzh.nl/student-aan-huis-wassenaar',
      provider: {
        '@id': 'https://computerhulpzh.nl/#organization'
      },
    ...
    },
    {
      ...
      url: 'https://computerhulpzh.nl/student-aan-huis-wassenaar',
      name: 'Student aan Huis | Computerhulp Wassenaar',
...
const faqData = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Een student aan huis kost €14,50 per kwartier met een minimum van 3 kwartier (€43,50 totaal). Er zijn geen voorrijkosten in heel Wassenaar. Dezelfde prijs als reguliere computerhulp.'
      }
    },
    {
      '@type': 'Question',
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: {
        '@id': 'https://computerhulpzh.nl/student-aan-huis-wassenaar',
        name: 'Student aan Huis Wassenaar'
      }
    }
  ]
}
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-4xl">
            ...
            <p className="text-xl sm:text-2xl text-blue-100 mb-8 leading-relaxed">
              ...
              in <strong className="text-white">Wassenaar</strong>. Geduldig uitleggen, rustig helpen.
      ...
      <PricingSection benefits={[
        'Geen voorrijkosten in heel Wassenaar',
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
            Waarom Kiezen Voor Student aan Huis in Wassenaar?
          </h2>

          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 leading-relaxed mb-6">
              <strong>Student aan huis</strong> is een unieke vorm van computerhulp waarbij jonge IT-studenten
              bij u thuis komen voor computer, laptop en internet problemen. In heel Wassenaar bieden wij
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              De grote voordelen van student aan huis computerhulp in Wassenaar zijn duidelijk:
            </p>
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700">
                  <strong>Heel Wassenaar:</strong> Van Den Haag tot Rotterdam, van Leiden tot Delft -
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              ontdek waarom zoveel mensen in Wassenaar vertrouwen op onze student aan huis service.
            </p>
          </div>
        </div>
      </section>
      ...
      <NearbyCities currentCity="wassenaar" pageType="student-aan-huis" />
