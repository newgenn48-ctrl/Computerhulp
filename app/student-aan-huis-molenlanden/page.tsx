...
export const metadata: Metadata = {
  ...
  description: '🎓 Student aan huis in Molenlanden. Jonge, geduldige IT-studenten binnen 24u bij u thuis! ✓ Computer, laptop, WiFi hulp ✓ Rustig uitleggen ✓ Vanaf €43,50. Bel.',
  openGraph: {
