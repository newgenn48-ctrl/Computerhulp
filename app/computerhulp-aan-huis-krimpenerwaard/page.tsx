...
export const metadata: Metadata = {
  ...
  description: 'Professionele computerhulp aan huis in Krimpenerwaard. Hulp met computer, laptop, printer, WiFi en meer. Geen voorrijkosten, binnen 24 uur. Bel 06-42548451.',
  openGraph: {
    title: 'Computerhulp aan Huis Krimpenerwaard | Binnen 24u',
