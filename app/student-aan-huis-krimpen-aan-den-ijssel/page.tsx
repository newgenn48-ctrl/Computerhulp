...
export const metadata: Metadata = {
  ...
  description: '🎓 Student aan huis in Krimpen aan den IJssel. Jonge, geduldige IT-studenten binnen 24u bij u thuis! ✓ Computer, laptop, WiFi hulp ✓ Rustig uitleggen ✓ Vanaf.',
  openGraph: {
