...
export const metadata: Metadata = {
  ...
  description: '💻 Computerhulp aan huis in Leidschendam-Voorburg. Binnen 24 uur bij u thuis! ✓ Computer, laptop, printer, WiFi ✓ Geen voorrijkosten ✓ Transparant tarief. Bel.',
  openGraph: {
    title: 'Computerhulp aan Huis Leidschendam-Voorburg | Binnen 24u bij u Thuis',
...
const structuredData = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Professionele computerhulp aan huis in heel Leidschendam-Voorburg. We komen binnen 24 uur bij u thuis voor computer, laptop, printer, WiFi en email.',
      url: 'https://computerhulpzh.nl/computerhulp-aan-huis-leidschendam-voorburg',
      provider: {
        '@id': 'https://computerhulpzh.nl/#organization'
      },
    ...
    },
    {
      ...
      description: 'Computerhulp aan huis in heel Leidschendam-Voorburg. Computer, laptop, printer of WiFi problemen? Wij komen binnen 24 uur bij u thuis. Geen voorrijkosten..',
      isPartOf: {
