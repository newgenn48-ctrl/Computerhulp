...
export const metadata: Metadata = {
  ...
  description: '💻 Computerhulp aan huis in Capelle aan den IJssel. Binnen 24 uur bij u thuis! ✓ Computer, laptop, printer, WiFi ✓ Geen voorrijkosten ✓ Transparant tarief..',
  openGraph: {
    title: 'Computerhulp aan Huis Capelle aan den IJssel | Binnen 24u bij u Thuis',
...
const structuredData = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Professionele computerhulp aan huis in heel Capelle aan den IJssel. We komen binnen 24 uur bij u thuis voor computer, laptop, printer, WiFi en email.',
      url: 'https://computerhulpzh.nl/computerhulp-aan-huis-capelle-aan-den-ijssel',
      provider: {
        '@id': 'https://computerhulpzh.nl/#organization'
      },
    ...
    },
    {
      ...
      description: 'Computerhulp aan huis in heel Capelle aan den IJssel. Computer, laptop, printer of WiFi problemen? Wij komen binnen 24 uur bij u thuis. Geen voorrijkosten..',
      isPartOf: {
