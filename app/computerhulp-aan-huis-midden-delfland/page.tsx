...
export const metadata: Metadata = {
  ...
  description: 'Professionele computerhulp aan huis in Midden-Delfland. Hulp met computer, laptop, printer, WiFi en meer. Geen voorrijkosten, binnen 24 uur. Bel 085-8002006.',
  openGraph: {
    title: 'Computerhulp aan Huis Midden-Delfland | Binnen 24u',
