...
export const metadata: Metadata = {
  title: 'Student aan Huis Kaag en Braassem | IT-Student Binnen 24u | €14,50',
  description: '🎓 Student aan huis in Kaag en Braassem. Jonge, geduldige IT-studenten binnen 24u bij u thuis! ✓ Computer, laptop, WiFi hulp ✓ Rustig uitleggen ✓ Vanaf €43,50. Bel 06-42548451.',
  openGraph: {
    title: 'Student aan Huis Kaag en Braassem | IT-Studenten Binnen 24u',
    description: 'Jonge, geduldige IT-studenten binnen 24u bij u thuis in Kaag en Braassem. Geduldig uitleggen, rustig helpen. Vanaf €43,50. Bel 06-42548451',
    type: 'website',
    url: 'https://computerhulpzh.nl/student-aan-huis-kaag-en-braassem',
  },
  alternates: {
    canonical: 'https://computerhulpzh.nl/student-aan-huis-kaag-en-braassem',
  },
}
  ...
  '@graph': [
    {
      ...
      image: {
        ...
        caption: 'Computerhulp Kaag en Braassem - Student aan Huis'
      },
      address: {
        '@type': 'PostalAddress',
    ...
    },
    {
      ...
      description: 'Computerhulp door jonge IT-studenten aan huis in Kaag en Braassem. Geduldig, betaalbaar en kundig. Perfect voor wie liever met een jongere werkt.',
      url: 'https://computerhulpzh.nl/student-aan-huis-kaag-en-braassem',
      provider: {
        '@id': 'https://computerhulpzh.nl/#organization'
      },
    ...
    },
    {
      ...
      url: 'https://computerhulpzh.nl/student-aan-huis-kaag-en-braassem',
      name: 'Student aan Huis | Computerhulp Kaag en Braassem',
...
const faqData = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Een student aan huis kost €14,50 per kwartier met een minimum van 3 kwartier (€43,50 totaal). Er zijn geen voorrijkosten in heel Kaag en Braassem. Dezelfde prijs als reguliere computerhulp.'
      }
    },
    {
      '@type': 'Question',
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: {
        '@id': 'https://computerhulpzh.nl/student-aan-huis-kaag-en-braassem',
        name: 'Student aan Huis Kaag en Braassem'
      }
    }
  ]
}
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              <span className="text-white">Student aan Huis</span>
              <br />
              <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                Jong, Geduldig & Kundig
              </span>
            </h1>

            <p className="text-xl sm:text-2xl text-blue-100 mb-8 leading-relaxed">
              Hulp nodig met computer, laptop of internet? Onze jonge IT-studenten komen bij u thuis
              in <strong className="text-white">Kaag en Braassem</strong>. Geduldig uitleggen, rustig helpen.
      ...
      <PricingSection benefits={[
        'Geen voorrijkosten in heel Kaag en Braassem',
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
            Waarom Kiezen Voor Student aan Huis in Kaag en Braassem?
          </h2>

          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 leading-relaxed mb-6">
              <strong>Student aan huis</strong> is een unieke vorm van computerhulp waarbij jonge IT-studenten
              bij u thuis komen voor computer, laptop en internet problemen. In heel Kaag en Braassem bieden wij
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              De grote voordelen van student aan huis computerhulp in Kaag en Braassem zijn duidelijk:
            </p>
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700">
                  <strong>Heel Kaag en Braassem:</strong> Van Den Haag tot Rotterdam, van Leiden tot Delft -
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              ontdek waarom zoveel mensen in Kaag en Braassem vertrouwen op onze student aan huis service.
            </p>
          </div>
        </div>
      </section>
      ...
      <NearbyCities currentCity="kaag-en-braassem" pageType="student-aan-huis" />
