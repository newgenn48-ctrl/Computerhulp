...
const structuredData = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Professionele computerhulp aan huis in heel Dordrecht. We komen binnen 24 uur bij u thuis voor computer, laptop, printer, WiFi en email problemen. Geen.',
      url: 'https://computerhulpzh.nl/computerhulp-aan-huis-dordrecht',
      provider: {
        '@id': 'https://computerhulpzh.nl/#organization'
      },
    ...
    },
    {
      ...
      description: 'Computerhulp aan huis in heel Dordrecht. Computer, laptop, printer of WiFi problemen? Wij komen binnen 24 uur bij u thuis. Geen voorrijkosten. Bel direct:.',
      isPartOf: {
