        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: 'Wat kost computerhulp?', a: `${PRICING.PER_QUARTER} per kwartier met een minimum van 3 kwartier (${PRICING.MINIMUM_TOTAL}). Voorrijden is gratis in heel Zuid-Holland. Betalen pas achteraf via pin of Tikkie.` },
