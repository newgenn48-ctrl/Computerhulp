...
export const metadata: Metadata = {
  ...
  description: '💻 Computerhulp aan huis in Alphen aan den Rijn. Binnen 24 uur bij u thuis! ✓ Computer, laptop, printer, WiFi ✓ Geen voorrijkosten ✓ Transparant tarief. Bel.',
  openGraph: {
    title: 'Computerhulp aan Huis Alphen aan den Rijn | Binnen 24u bij u Thuis',
...
const structuredData = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Professionele computerhulp aan huis in heel Alphen aan den Rijn. We komen binnen 24 uur bij u thuis voor computer, laptop, printer, WiFi en email problemen..',
      url: 'https://computerhulpzh.nl/computerhulp-aan-huis-alphen-aan-den-rijn',
      provider: {
        '@id': 'https://computerhulpzh.nl/#organization'
      },
    ...
    },
    {
      ...
      description: 'Computerhulp aan huis in heel Alphen aan den Rijn. Computer, laptop, printer of WiFi problemen? Wij komen binnen 24 uur bij u thuis. Geen voorrijkosten. Bel.',
      isPartOf: {
