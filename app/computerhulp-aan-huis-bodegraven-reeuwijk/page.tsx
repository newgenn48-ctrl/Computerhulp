...
export const metadata: Metadata = {
  ...
  description: '💻 Computerhulp aan huis in Bodegraven-Reeuwijk. Binnen 24 uur bij u thuis! ✓ Computer, laptop, printer, WiFi ✓ Geen voorrijkosten ✓ Transparant tarief. Bel.',
  openGraph: {
    title: 'Computerhulp aan Huis Bodegraven-Reeuwijk | Binnen 24u bij u Thuis',
...
const structuredData = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Professionele computerhulp aan huis in heel Bodegraven-Reeuwijk. We komen binnen 24 uur bij u thuis voor computer, laptop, printer, WiFi en email problemen..',
      url: 'https://computerhulpzh.nl/computerhulp-aan-huis-bodegraven-reeuwijk',
      provider: {
        '@id': 'https://computerhulpzh.nl/#organization'
      },
    ...
    },
    {
      ...
      description: 'Computerhulp aan huis in heel Bodegraven-Reeuwijk. Computer, laptop, printer of WiFi problemen? Wij komen binnen 24 uur bij u thuis. Geen voorrijkosten. Bel.',
      isPartOf: {
