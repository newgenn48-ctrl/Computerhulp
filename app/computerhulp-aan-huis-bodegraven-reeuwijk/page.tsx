...
export const metadata: Metadata = {
  title: 'Computerhulp aan Huis Bodegraven-Reeuwijk | Binnen 24u bij u Thuis',
  description: '💻 Computerhulp aan huis in Bodegraven-Reeuwijk. Binnen 24 uur bij u thuis! ✓ Computer, laptop, printer, WiFi ✓ Geen voorrijkosten ✓ Transparant tarief. Bel 06-42548451.',
  openGraph: {
    title: 'Computerhulp aan Huis Bodegraven-Reeuwijk | Binnen 24u bij u Thuis',
    description: 'Binnen 24 uur bij u thuis in Bodegraven-Reeuwijk. Computer, laptop, printer, WiFi problemen opgelost. Geen voorrijkosten. Bel 06-42548451',
    type: 'website',
  ...
  '@graph': [
    {
      ...
      name: 'Computerhulp Bodegraven-Reeuwijk',
      ...
      logo: {
        ...
        caption: 'Computerhulp Bodegraven-Reeuwijk Logo'
      },
      image: {
        '@type': 'ImageObject',
        ...
        caption: 'Computerhulp Bodegraven-Reeuwijk - Professionele IT Service'
      },
      address: {
        '@type': 'PostalAddress',
    ...
    },
    {
      ...
      name: 'Computerhulp aan Huis Bodegraven-Reeuwijk',
      description: 'Professionele computerhulp aan huis in heel Bodegraven-Reeuwijk. We komen binnen 24 uur bij u thuis voor computer, laptop, printer, WiFi en email problemen. Geen voorrijkosten, transparante prijzen van €14,50 per kwartier.',
      url: 'https://computerhulpzh.nl/computerhulp-aan-huis-bodegraven-reeuwijk',
      provider: {
        '@id': 'https://computerhulpzh.nl/#organization'
      },
      ...
      audience: {
        '@type': 'Audience',
        audienceType: 'Particulieren en bedrijven in Bodegraven-Reeuwijk',
        geographicArea: {
          '@type': 'State',
          name: 'Bodegraven-Reeuwijk'
        }
    ...
    },
    {
      ...
      url: 'https://computerhulpzh.nl/computerhulp-aan-huis-bodegraven-reeuwijk',
      name: 'Computerhulp aan Huis Bodegraven-Reeuwijk | Binnen 24 Uur | €14,50',
      description: 'Computerhulp aan huis in heel Bodegraven-Reeuwijk. Computer, laptop, printer of WiFi problemen? Wij komen binnen 24 uur bij u thuis. Geen voorrijkosten. Bel direct: 06-42548451',
      isPartOf: {
    ...
    },
    {
      ...
      url: 'https://computerhulpzh.nl',
      name: 'Computerhulp Bodegraven-Reeuwijk',
      description: 'Professionele computerhulp aan huis in Bodegraven-Reeuwijk',
      publisher: {
        '@id': 'https://computerhulpzh.nl/#organization'
      },
      inLanguage: 'nl-NL',
...
const faqData = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      name: 'Wat kost computerhulp aan huis in Bodegraven-Reeuwijk?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Onze computerhulp aan huis kost €14,50 per kwartier met een minimum van 3 kwartier (€43,50 totaal). Er zijn geen voorrijkosten in heel Bodegraven-Reeuwijk.'
      }
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We bieden computerhulp aan huis in heel Bodegraven-Reeuwijk, inclusief Den Haag, Rotterdam, Leiden, Delft, Zoetermeer, Gouda, Dordrecht, Alphen aan den Rijn en alle kleinere plaatsen. Overal zonder voorrijkosten.'
      }
    }
  ]
}
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: {
        '@id': 'https://computerhulpzh.nl/computerhulp-aan-huis-bodegraven-reeuwijk',
        name: 'Computerhulp aan Huis Bodegraven-Reeuwijk'
      }
    }
  ]
...
export default function ComputerhulpAanHuisPage() {
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl sm:text-2xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">
              Computer, laptop, printer of WiFi problemen in <strong className="text-white">Bodegraven-Reeuwijk</strong>?
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Waarom Kiezen Voor Computerhulp aan Huis in Bodegraven-Reeuwijk?
            </h2>
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              In heel Bodegraven-Reeuwijk bieden wij professionele computerhulp aan huis. Of u nu in Den Haag, Rotterdam, Leiden, Delft, Zoetermeer of een andere plaats woont - we komen bij u langs. Binnen 24 uur na uw aanvraag staan we bij u op de stoep, ook in de avonduren en in het weekend.
            </p>
            ...
            <ul className="space-y-3 text-gray-700 mb-6">
              ...
              <li className="flex items-start gap-3">
                ...
                <span><strong>Hele provincie:</strong> Onze computerhulp aan huis is beschikbaar in heel Bodegraven-Reeuwijk zonder voorrijkosten.</span>
              </li>
            </ul>
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Meer dan 500 tevreden klanten geholpen bij hen thuis in Bodegraven-Reeuwijk
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-xl text-blue-100 mb-10">
            We komen vandaag of morgen al bij u thuis in Bodegraven-Reeuwijk. Geen voorrijkosten, binnen 24 uur geholpen.
          </p>
      ...
      <NearbyCities currentCity="bodegraven-reeuwijk" pageType="computerhulp-aan-huis" />
