...
export const metadata: Metadata = {
  ...
  description: 'Professionele computerhulp aan huis in Molenlanden. Hulp met computer, laptop, printer, WiFi en meer. Geen voorrijkosten, binnen 24 uur. Bel 085-8002006.',
  openGraph: {
    title: 'Computerhulp aan Huis Molenlanden | Binnen 24u bij u Thuis',
    description: 'Computerhulp aan huis in Molenlanden. Computer, laptop, WiFi hulp. Binnen 24u, geen voorrijkosten.',
    type: 'website',
