...
export const metadata: Metadata = {
  ...
  description: 'Professionele computerhulp aan huis in Oegstgeest. Hulp met computer, laptop, printer, WiFi en meer. Geen voorrijkosten, binnen 24 uur. Bel 06-42548451.',
  openGraph: {
    title: 'Computerhulp aan Huis Oegstgeest | Binnen 24u bij u Thuis',
