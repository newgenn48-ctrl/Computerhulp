...
export const metadata: Metadata = {
  ...
  description: `PC hulp aan huis in ${BUSINESS.REGION}. Laptop, WiFi, printer en meer. Binnen 24 uur, ${PRICING.TRAVEL.toLowerCase()} voorrijden. Bel ${BUSINESS.PHONE}.`,
  openGraph: {
    title: 'PC Hulp aan Huis Zuid-Holland | IT-student aan Huis',
    description: `PC hulp aan huis in ${BUSINESS.REGION}: uw IT-student aan huis. Binnen 24 uur bij u thuis. ${PRICING.TRAVEL} voorrijkosten. ${PRICING.PER_QUARTER} per kwartier.`,
    type: 'website',
...
const faqData = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: `Onze computerhulp aan huis kost ${PRICING.PER_QUARTER} per kwartier met een minimum van 3 kwartier (${PRICING.MINIMUM_TOTAL}). Voorrijden is gratis in heel ${BUSINESS.REGION}. Betalen kan na afloop via pin of Tikkie.`
      }
    },
    {
      '@type': 'Question',
