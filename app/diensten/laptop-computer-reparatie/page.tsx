...
export const metadata: Metadata = {
  title: 'Laptop & Computer Reparatie aan Huis in Zuid-Holland | Binnen 24u',
  description: 'Laptop of computer kapot? Scherm, toetsenbord of hardware defect? Wij repareren bij u thuis in Zuid-Holland. Geen voorrijkosten. Bel 06-42548451.',
  keywords: 'laptop reparatie, computer reparatie, laptop kapot, scherm reparatie, toetsenbord reparatie, computer defect, Zuid-Holland',
  openGraph: {
    title: 'Laptop & Computer Reparatie aan Huis',
    description: 'Laptop of computer kapot? Wij repareren bij u thuis in Zuid-Holland. Bel 06-42548451.',
    type: 'website'},
  alternates: {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 rounded-full px-4 py-2 mb-6">
                <span className="text-sm font-medium">Reparatie Specialist</span>
              </div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Laptop kapot? Computer defect? Scherm gebroken of start niet meer op? Wij komen bij u thuis in Zuid-Holland en repareren het ter plekke. <strong className="text-gray-900">Binnen 24 uur geholpen.</strong>
              </p>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img src={heroImage} alt="Laptop en computer reparatie specialist aan het werk" className="w-full h-[400px] lg:h-[500px] object-cover" loading="eager" />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Veelvoorkomende Problemen</h2>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Wat We Repareren</h2>
            <p className="text-lg text-gray-600">Van hardware tot software - alle reparaties aan huis</p>
          </div>
