...
const structuredData = {
  ...
  description: 'Professionele WiFi en internet hulp aan huis. Van router installatie tot WiFi optimalisatie en bereik vergroten. We komen bij u thuis in Zuid-Holland.',
}
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://computerhulpzh.nl/diensten/wifi-internet-hulp'
    }
  ]
}
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-4xl">
            ...
            >
              WiFi & Internet Hulp<br/>
              Direct Bij U Thuis Opgelost
            </h1>

            <p className="text-xl sm:text-2xl text-blue-100 mb-8 leading-relaxed max-w-3xl">
              Geen internet, WiFi valt steeds weg, traag internet of apparaten verbinden niet? We komen bij u thuis in Zuid-Holland en maken uw internet snel en stabiel. Binnen 24 uur geholpen.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Veelvoorkomende WiFi & Internet Problemen
            </h2>
            <p className="text-lg text-gray-600">
              We lossen alle WiFi en internet problemen op bij u thuis
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Van router installatie tot WiFi optimalisatie en bereik vergroten - wij komen bij u thuis en lossen het op
            </p>
          </div>
            ...
            <div className="bg-white rounded-xl p-6 mb-8">
              <ul className="space-y-3">
                {[
                  ...
                  'Internet direct weer snel en stabiel',
                  'WiFi in heel huis optimaal',
...
const problems = [
  {
    icon: '🔌',
    title: 'Geen Internet',
    description: 'Helemaal geen internet, router lampjes knipperen rood, of verbinding compleet weg.',
    solution: 'We checken kabels, router, modem en provider instellingen en maken internet weer werkend.'
  },
  {
    icon: '📶',
    title: 'WiFi Valt Weg',
    description: 'WiFi verbinding valt steeds weg, moet opnieuw verbinden, of verliest regelmatig signaal.',
    solution: 'Router optimaal instellen, kanalen aanpassen, interferentie verminderen voor stabiel WiFi.'
  },
  {
    icon: '🐌',
    title: 'Traag Internet',
    description: 'Internet is erg langzaam, pagina\'s laden niet, of video\'s bufferen constant.',
    solution: 'Snelheid testen, router optimaliseren, bekabeling checken, en internetproblemen oplossen.'
  },
  {
    icon: '📍',
    title: 'WiFi Bereik Te Klein',
    description: 'Boven geen WiFi, achter in huis geen bereik, of signaal te zwak in bepaalde kamers.',
    solution: 'WiFi bereik vergroten met repeaters, mesh netwerk, of betere router plaatsing.'
  },
  {
    icon: '📱',
    title: 'Apparaten Verbinden Niet',
    description: 'Telefoon, laptop of tablet kunnen niet verbinden met WiFi, of blijven verbinding verliezen.',
    solution: 'WiFi wachtwoord opnieuw instellen, apparaten correct configureren, en verbindingsproblemen oplossen.'
  },
  {
    icon: '⚠️',
    title: 'Router Problemen',
    description: 'Router werkt niet, moet steeds herstarten, of geeft foutmeldingen.',
    solution: 'Router herstarten, firmware updaten, instellingen resetten, of nieuwe router configureren.'
  }
]
...
const services = [
  {
    icon: '🔧',
    title: 'Router Installatie',
    items: [
      'Nieuwe router installeren en configureren',
      'Provider instellingen correct invoeren',
      'WiFi naam en wachtwoord instellen',
      'Beveiliging optimaal configureren',
      'Alle lampjes op groen krijgen'
    ]
  },
  {
    icon: '⚡',
    title: 'WiFi Optimalisatie',
    items: [
      'WiFi kanaal optimaliseren voor snelheid',
      'Router op beste locatie plaatsen',
      'Interferentie van buren verminderen',
      '5GHz en 2.4GHz correct instellen',
      'Maximale snelheid uit internet halen'
    ]
  },
  {
    icon: '📡',
    ...
    items: [
      'WiFi repeaters installeren en positioneren',
      'Mesh netwerk opzetten voor heel huis',
      'Powerline adapters configureren',
      'Extra access points plaatsen',
      'WiFi in elke kamer werkend krijgen'
    ]
  },
  {
    icon: '🔗',
    ...
    items: [
      'Alle apparaten aan WiFi koppelen',
      'Smart TV, printer, telefoons verbinden',
      'Gastnetwerk instellen voor bezoekers',
      'Ouderlijk toezicht configureren',
      'Netwerknaam zichtbaar voor iedereen'
    ]
  }
]
