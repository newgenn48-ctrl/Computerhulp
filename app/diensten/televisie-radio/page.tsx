...
export default function TelevisieRadioPage() {
  return (
    <>
      ...
      {/* Hero - Split Layout */}
      <section className="hero-wrapper" aria-label="TV & Radio aan huis hero">
        ...
        <div className="hero-content">
          <div className="max-w-2xl">
            <p className="hero-eyebrow">TV & Radio · {BUSINESS.REGION}</p>
            <h1 className="hero-title">
              Problemen met uw <span className="hero-highlight">tv</span> of radio?
            </h1>

            <p className="hero-description">
              Heeft u problemen met uw tv of radio? Nieuwe TV installeren, zenders kwijt of Smart TV instellen? We komen bij u thuis en zorgen dat alles <strong className="text-white">weer perfect werkt</strong>.
            </p>
      ...
      <section className="cta-section-blue">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="cta-title mb-6">TV Problemen? We Helpen Direct!</h2>
