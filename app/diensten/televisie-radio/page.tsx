    ...
    <>
      ...
      <section className="hero-wrapper" aria-label="TV & Radio aan huis hero">
        <div className="absolute inset-0">
          <Image
            src={heroImage}
            alt={`TV & Radio aan huis in ${BUSINESS.REGION}`}
            fill
        ...
        <div className="hero-content">
          <div className="max-w-2xl">
            ...
            <h1 className="hero-title">
              Problemen met je <span className="text-accent-400">tv</span> of radio?
            </h1>

            <p className="hero-description">
              Nieuwe TV installeren, zenders kwijt of Smart TV instellen? We komen bij je thuis en zorgen dat alles <strong className="text-white">weer perfect werkt</strong>.
            </p>
