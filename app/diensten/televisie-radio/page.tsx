...
export const metadata: Metadata = {
  ...
  description: 'TV of radio problemen? Zenders weg, storing of installatie nodig? Wij komen bij u thuis in Zuid-Holland. €10 voorrijkosten. Bel 085-8002006.',
  openGraph: {
          ...
          <div className="pricing-box">
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-6 mb-8">
              <ul className="space-y-3 text-left">
                {['Slechts €10 voorrijkosten in heel Zuid-Holland', 'TV en decoder direct werkend', 'Alle zenders perfect ingesteld', 'Betalen na afloop via pin, contant of Tikkie'].map((item, idx) => (
