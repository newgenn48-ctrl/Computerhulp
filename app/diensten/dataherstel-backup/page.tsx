...
export const metadata: Metadata = {
  title: 'Dataherstel & Backup aan Huis in Zuid-Holland | Binnen 24u',
  description: 'Bestanden kwijt of harde schijf kapot? Wij redden uw data en maken backups aan huis in Zuid-Holland. Geen voorrijkosten. Bel 06-42548451.',
  keywords: 'data herstel, backup, bestanden kwijt, harde schijf kapot, data recovery, backup maken, data redden, Zuid-Holland',
  openGraph: {
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 rounded-full px-4 py-2 mb-6">
                <span className="text-sm font-medium">Dataherstel Specialist</span>
              </div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img src={heroImage} alt="Dataherstel en backup specialist aan het werk" className="w-full h-[400px] lg:h-[500px] object-cover" loading="eager" />
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">Van dataherstel tot automatische backup oplossingen</p>
          </div>
