    ...
    <>
      ...
      <section className="hero-wrapper" aria-label="Dataherstel aan huis hero">
        <div className="absolute inset-0">
          <Image
            src={heroImage}
            alt={`Dataherstel aan huis in ${BUSINESS.REGION}`}
            fill
        ...
        <div className="hero-content">
          <div className="max-w-2xl">
            ...
            <p className="hero-description">
              Harde schijf defect, bestanden verdwenen of computer start niet meer op? We maken eerst een <strong className="text-white">eerlijke diagnose</strong> — pas als herstel realistisch is, gaan we aan de slag.
            </p>
