...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp voor senioren aan huis in Zuid-Holland. Geduldig, duidelijk en op uw gemak. Laptop, WiFi, printer en meer. Binnen 24 uur, €10 voorrijkosten. Bel 085-8002006.',
  openGraph: {
    title: 'Computerhulp voor Senioren | IT-student aan Huis',
    description: 'Computerhulp voor senioren in Zuid-Holland: uw IT-student aan huis. Binnen 24 uur bij u thuis. €10 voorrijkosten. €14,99 per kwartier.',
    type: 'website',
...
const localBusinessData = {
  ...
  description: 'Professionele computerhulp voor senioren aan huis in Zuid-Holland. Wij lossen computer-, laptop-, printer- en WiFi-problemen snel op. Binnen 24 uur bij u thuis, €10 voorrijkosten.',
  url: 'https://computerhulpzh.nl/diensten/computerhulp-senioren',
  telephone: '+31858002006',
...
const serviceData = {
  ...
  description: 'Professionele computerhulp voor senioren aan huis voor particulieren in Zuid-Holland. Wij lossen computer, laptop, printer, WiFi en andere IT-problemen snel en vakkundig op.',
  offers: {
    '@type': 'Offer',
    price: '14.99',
    priceCurrency: 'EUR',
        ...
        <div className="hero-content">
          <div className="max-w-2xl">
            <h1 className="hero-title">
              Computerhulp voor <span className="text-blue-600">Senioren</span>
            </h1>
