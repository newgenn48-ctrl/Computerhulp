...
const faqData = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Wat kost het om een laptop te laten herstellen?', acceptedAnswer: { '@type': 'Answer', text: `Laptop herstel kost ${PRICING.PER_QUARTER} per kwartier met een minimum van 3 kwartier (${PRICING.MINIMUM_TOTAL}). Voorrijden kost slechts ${PRICING.TRAVEL} in heel ${BUSINESS.REGION}. De meeste problemen lossen we op voor minder dan €55.` } },
...
const faqs = [
  { question: 'Wat kost het om een laptop te laten herstellen?', answer: `Laptop herstel kost ${PRICING.PER_QUARTER} per kwartier met een minimum van 3 kwartier (${PRICING.MINIMUM_TOTAL} totaal). Voorrijden kost slechts ${PRICING.TRAVEL} in heel Zuid-Holland. De meeste problemen lossen we op in 45 tot 90 minuten.` },
  ...
  return (
    <>
      ...
      <section className="py-12 lg:py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="content-title mb-4">Laptop Laten Herstellen zonder Gedoe</h2>
          <div className="prose prose-lg text-gray-600 max-w-none">
            <p>Uw laptop laten herstellen hoeft niet ingewikkeld te zijn. Geen apparaat inleveren bij een winkel, geen weken wachten. Onze IT-specialisten komen gewoon bij u thuis en herstellen uw laptop aan de keukentafel. Of het nu gaat om een trage laptop die dringend een opschoning nodig heeft, een kapot scherm, een virus, of een laptop die niet meer opstart — wij lossen het ter plekke op.</p>
      ...
      <section className="cta-section-blue">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="cta-title mb-6">Laptop Laten Herstellen?</h2>
