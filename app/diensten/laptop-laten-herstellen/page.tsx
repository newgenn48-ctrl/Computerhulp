    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="section-title">Wat Kost Laptop Herstel?</h2>
          ...
          <div className="pricing-box">
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-6 mb-8">
              <ul className="space-y-3 text-left">
                {['Slechts €10 voorrijkosten in heel Zuid-Holland', 'Diagnose ter plekke inbegrepen', 'Onderdelen tegen inkoopprijs', 'Betalen na afloop via pin of Tikkie'].map((item, idx) => (
