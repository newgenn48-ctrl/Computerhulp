...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: OG_IMAGE,
    title: 'E-mailhulp aan huis',
    description: `E-mail problemen? Niet meer kunnen inloggen? We komen bij u thuis in ${BUSINESS.REGION}. Meestal binnen 24 uur geholpen.`,
    type: 'website',
    ...
    <>
      ...
      <section className="hero-wrapper" aria-label="E-mail hulp aan huis hero">
        <div className="absolute inset-0">
          <Image
            src="/dienst-email.webp"
            alt="Laptopscherm met een geopende e-mail"
            fill
        ...
        <div className="hero-content">
          <div className="max-w-2xl">
            ...
            <h1 className="hero-title">
              Hulp nodig met uw <span className="hero-highlight">e-mail</span>?
            </h1>
      ...
      <section className="cta-section-blue">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="cta-title mb-6">E-mailproblemen?</h2>
