          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 rounded-full px-4 py-2 mb-6">
                <span className="text-sm font-medium">Tablet & Smartphone Specialist</span>
              </div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img src={heroImage} alt="Tablet en smartphone hulp aan huis in Zuid-Holland" className="w-full h-[400px] lg:h-[500px] object-cover" loading="eager" />
