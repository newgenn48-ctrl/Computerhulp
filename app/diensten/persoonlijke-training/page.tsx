...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'internet training',
    'word excel leren',
    'online bankieren hulp',
    'computer cursus aan huis',
    'computer training zuid-holland',
    'senioren computer les'
  ],
  openGraph: {
    title: 'Persoonlijke Computer Training aan Huis | Computerhulp Zuid-Holland',
    description: 'Computer leren op uw tempo? We komen bij u thuis voor persoonlijke training. Bel 06-42548451.',
    type: 'website',
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://computerhulpzh.nl/diensten/persoonlijke-training'
    }
  ]
}
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-4xl">
            ...
            >
              Persoonlijke Training<br/>
              Direct Bij U Thuis Opgelost
            </h1>

            <p className="text-xl sm:text-2xl text-blue-100 mb-8 leading-relaxed max-w-3xl">
              Computer basics leren, internet veilig gebruiken, online bankieren of Word en Excel onder de knie krijgen? We komen bij u thuis in Zuid-Holland voor persoonlijke training. Op uw tempo, zonder haast.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Persoonlijke training afgestemd op uw behoeften en tempo
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
              Onze Training Onderwerpen
            </h2>
            <p className="text-xl text-gray-600 leading-relaxed">
              Van computer basics tot Office programma&apos;s - wij trainen u thuis op uw eigen computer
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Wat Kost Persoonlijke Training?
            </h2>
            <p className="text-lg text-gray-600">
              Transparante prijzen, betaal per les
            </p>
          </div>
            ...
            <div className="bg-white rounded-xl p-6 mb-8">
              <ul className="space-y-3">
                {[
                  ...
                  'Training bij u thuis op eigen computer',
                  'Op uw tempo, zonder haast of druk',
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">
            Computer Vaardigheden Verbeteren?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Bel nu voor persoonlijke training bij u thuis
          </p>
...
const problems = [
  {
    icon: '🖱️',
    title: 'Computer Basics Leren',
    description: 'Net begonnen met computer, weet niet hoe het werkt, basis functionaliteiten onduidelijk.',
    solution: 'Muis en toetsenbord gebruiken, bestanden openen en opslaan, programma\'s starten, Windows basis.'
  },
  {
    icon: '🌐',
    title: 'Internet Veilig Gebruiken',
    description: 'Internet eng of onduidelijk, weet niet hoe te zoeken, veiligheid is een zorg.',
    solution: 'Google gebruiken, websites bezoeken, veilig internetten, herkennen van betrouwbare sites.'
  },
  {
    icon: '💳',
    title: 'Online Bankieren',
    description: 'Wil online kunnen bankieren maar weet niet hoe, of bang voor veiligheid.',
    solution: 'Bankieren app of website gebruiken, overmaken, saldo checken, veilig inloggen met DigiD.'
  },
  {
    icon: '📸',
    title: 'Foto\'s Beheren',
    description: 'Foto\'s van camera/telefoon op computer krijgen, ordenen en bewerken.',
    solution: 'Foto\'s importeren, mappen maken, foto\'s sorteren, eenvoudig bewerken en afdrukken.'
  },
  {
    icon: '📄',
    title: 'Word/Excel Leren',
    description: 'Brieven schrijven in Word, of simpele begroting maken in Excel.',
    solution: 'Word document maken, tekst opmaken, Excel tabel maken, formules gebruiken, printen.'
  },
  {
    icon: '📧',
    title: 'Email en Communicatie',
    description: 'Email versturen, bijlagen toevoegen, of videobellen met kleinkinderen.',
    solution: 'Emails schrijven en versturen, bestanden meesturen, Zoom/Skype/WhatsApp videobellen.'
  }
]
...
const services = [
  {
    ...
    items: [
      ...
      'Windows navigeren en programma\'s openen',
      'Bestanden en mappen beheren',
      'Computer aan/uit, updates en onderhoud',
      'Veilig wachtwoorden en accounts'
    ]
  },
  {
    icon: '🌍',
    ...
    items: [
      'Veilig internetten en zoeken met Google',
      'Websites bezoeken en favorieten',
      'Online winkelen en betalen',
      'Herkennen van phishing en spam',
      'Social media gebruik (Facebook, etc.)'
    ]
  },
  {
    icon: '📝',
    title: 'Office Programma\'s',
    items: [
      'Word: brieven en documenten maken',
      'Excel: tabellen en eenvoudige formules',
      'Tekst opmaken en lay-out',
      'Documenten opslaan en printen',
      'PDF bestanden maken en openen'
    ]
  },
  {
    icon: '📷',
    ...
    items: [
      'Foto\'s van camera/telefoon importeren',
      'Foto\'s ordenen in mappen',
      'Foto\'s eenvoudig bewerken',
      'Fotoalbum maken en afdrukken',
      'Foto\'s delen via email of WhatsApp'
    ]
  }
]
