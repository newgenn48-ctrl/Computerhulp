...
const faqData = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Wat kost een monteur aan huis?', acceptedAnswer: { '@type': 'Answer', text: `Onze monteur aan huis kost ${PRICING.PER_QUARTER} per kwartier met een minimum van 3 kwartier (${PRICING.MINIMUM_TOTAL}). Voorrijden kost slechts ${PRICING.TRAVEL} in heel ${BUSINESS.REGION}.` } },
...
const faqs = [
  { question: 'Wat kost een monteur aan huis?', answer: `Onze monteur aan huis kost ${PRICING.PER_QUARTER} per kwartier met een minimum van 3 kwartier (${PRICING.MINIMUM_TOTAL} totaal). Voorrijden kost slechts ${PRICING.TRAVEL} in heel Zuid-Holland. De meeste problemen lossen we op in 45 tot 90 minuten.` },
        ...
        <div className="hero-content">
          <div className="max-w-2xl">
            ...
            <h1 className="hero-title">
              <span className="hero-highlight">IT-monteur</span> aan huis nodig?
            </h1>
