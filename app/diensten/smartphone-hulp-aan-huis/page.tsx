...
export const metadata: Metadata = {
  ...
  description: `Smartphone hulp aan huis in ${BUSINESS.REGION}. Telefoon instellen, data overzetten, apps installeren en problemen oplossen. Binnen 24 uur, ${PRICING.TRAVEL.toLowerCase()} voorrijden. Bel ${BUSINESS.PHONE}.`,
  openGraph: {
