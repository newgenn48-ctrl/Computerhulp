        ...
        <div className="hero-content">
          <div className="max-w-2xl">
            ...
            <p className="hero-description">
              Op je eigen tempo leren omgaan met computer, tablet of smartphone. We leggen alles stap voor stap uit — <strong className="text-white">in gewone taal, op jouw tempo</strong>.
            </p>
