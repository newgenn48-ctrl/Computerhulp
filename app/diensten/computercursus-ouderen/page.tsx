...
export const metadata: Metadata = {
  ...
  description: `Computercursus voor ouderen aan huis in ${BUSINESS.REGION}. Persoonlijke uitleg over laptop, tablet, smartphone en meer. Binnen 24 uur, ${PRICING.TRAVEL.toLowerCase()} voorrijden. Bel ${BUSINESS.PHONE}.`,
  openGraph: {
              ...
              <div className="sticky top-24">
                <div className="relative h-80 lg:h-96 rounded-2xl overflow-hidden shadow-xl mb-8">
                  <Image
                    ...
                    alt="IT-student geeft rustige computercursus aan oudere klant thuis"
                    fill
