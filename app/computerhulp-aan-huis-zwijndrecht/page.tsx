...
export const metadata: Metadata = {
  ...
  description: 'Professionele computerhulp aan huis in Zwijndrecht. Hulp met computer, laptop, printer, WiFi en meer. Geen voorrijkosten, binnen 24 uur. Bel 06-42548451.',
  openGraph: {
    title: 'Computerhulp aan Huis Zwijndrecht | Binnen 24u bij u Thuis',
    description: 'Computerhulp aan huis in Zwijndrecht. Computer, laptop, WiFi hulp. Binnen 24u, geen voorrijkosten.',
    type: 'website',
