...
export const metadata: Metadata = {
  title: 'Student aan Huis Den Haag | IT-Student Binnen 24u | €14,50',
  description: '🎓 Student aan huis in Den Haag. Jonge, geduldige IT-studenten binnen 24u bij u thuis! ✓ Computer, laptop, WiFi hulp ✓ Rustig uitleggen ✓ Vanaf €43,50. Bel 06-42548451.',
  openGraph: {
    title: 'Student aan Huis Den Haag | IT-Studenten Binnen 24u',
    description: 'Jonge, geduldige IT-studenten binnen 24u bij u thuis in Den Haag. Geduldig uitleggen, rustig helpen. Vanaf €43,50. Bel 06-42548451',
    type: 'website',
...
const structuredData = {
  ...
  '@graph': [
    ...
    {
      '@type': 'Service',
      '@id': 'https://computerhulpzh.nl/student-aan-huis-den-haag#service',
      serviceType: 'Student aan Huis Computerhulp',
      name: 'Student aan Huis - Computerhulp door IT-Studenten Den Haag',
      description: 'Computerhulp door jonge IT-studenten aan huis in Den Haag. Geduldig, betaalbaar en kundig. Perfect voor wie liever met een jongere werkt.',
      url: 'https://computerhulpzh.nl/student-aan-huis-den-haag',
      provider: {
        '@id': 'https://computerhulpzh.nl/#organization'
      },
    ...
    {
      '@type': 'WebPage',
      '@id': 'https://computerhulpzh.nl/student-aan-huis-den-haag#webpage',
      url: 'https://computerhulpzh.nl/student-aan-huis-den-haag',
      name: 'Student aan Huis Den Haag | Computerhulp Zuid-Holland',
      description: 'Jonge, geduldige IT-studenten komen bij u thuis in Den Haag voor computerhulp. Vanaf €43,50. Bel 06-42548451',
      isPartOf: {
...
const faqData = {
  '@context': 'https://schema.org',
  '@type': 'FAQPage',
  '@id': 'https://computerhulpzh.nl/student-aan-huis-den-haag#faq',
  mainEntity: [
    {
      '@type': 'Question',
      '@id': 'https://computerhulpzh.nl/student-aan-huis-den-haag#faq-wat-is',
    ...
    {
      '@type': 'Question',
      '@id': 'https://computerhulpzh.nl/student-aan-huis-den-haag#faq-verschil',
    ...
    {
      '@type': 'Question',
      '@id': 'https://computerhulpzh.nl/student-aan-huis-den-haag#faq-prijs',
      name: 'Wat kost een student aan huis in Den Haag?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Een student aan huis kost €14,50 per kwartier met een minimum van 3 kwartier (€43,50 totaal). Er zijn geen voorrijkosten in Den Haag. Dezelfde prijs als reguliere computerhulp.'
      }
    },
    {
      '@type': 'Question',
      '@id': 'https://computerhulpzh.nl/student-aan-huis-den-haag#faq-kundig',
...
const breadcrumbData = {
  '@context': 'https://schema.org',
  '@type': 'BreadcrumbList',
  '@id': 'https://computerhulpzh.nl/student-aan-huis-den-haag#breadcrumb',
  itemListElement: [
    {
      '@type': 'ListItem',
      position: 1,
    ...
    },
    {
      ...
      item: {
        '@id': 'https://computerhulpzh.nl/student-aan-huis-den-haag',
        name: 'Student aan Huis Den Haag'
      }
    }
  ]
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-4xl">
            ...
            <p className="text-xl sm:text-2xl text-blue-100 mb-8 leading-relaxed">
              ...
              in <strong className="text-white">Den Haag</strong>. Geduldig uitleggen, rustig helpen.
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-sm font-semibold text-purple-600 uppercase tracking-wide mb-1">Afspraak</div>
                  <div className="text-xl font-bold text-gray-900 mb-1">Plan Direct</div>
                  <div className="text-sm text-gray-600">Kies uw tijd</div>
                </div>
              </div>
            </Link>
          </div>
      ...
      <PricingSection benefits={[
        'Geen voorrijkosten in heel Den Haag',
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
            Waarom Kiezen Voor Student aan Huis in Den Haag?
          </h2>

          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 leading-relaxed mb-6">
              <strong>Student aan huis</strong> is een unieke vorm van computerhulp waarbij jonge IT-studenten
              bij u thuis komen voor computer, laptop en internet problemen. In Den Haag bieden wij
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              De grote voordelen van student aan huis computerhulp in Den Haag zijn duidelijk:
            </p>
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700">
                  <strong>Heel Den Haag:</strong> Van het centrum tot Scheveningen, van Loosduinen tot Bezuidenhout -
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              ontdek waarom zoveel mensen in Den Haag vertrouwen op onze student aan huis service.
            </p>
          </div>
        </div>
      </section>
      ...
      <NearbyCities currentCity="den-haag" pageType="student-aan-huis" />
