...
const faqData = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Wat kost computerhulp aan huis?', acceptedAnswer: { '@type': 'Answer', text: `Computerhulp aan huis kost ${PRICING.PER_QUARTER} per kwartier met een minimum van 3 kwartier (${PRICING.MINIMUM_TOTAL}). Voorrijden kost slechts ${PRICING.TRAVEL} in heel ${BUSINESS.REGION}.` } },
    { '@type': 'Question', name: 'Zijn er voorrijkosten?', acceptedAnswer: { '@type': 'Answer', text: `Ja, voorrijden kost slechts ${PRICING.TRAVEL} in heel ${BUSINESS.REGION}. Dit is een vast bedrag, ongeacht waar u woont.` } },
      ...
      <section className="py-12 lg:py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            {[
              { q: 'Wat kost computerhulp aan huis?', a: `Wij rekenen ${PRICING.PER_QUARTER} per kwartier met een minimum van 3 kwartier (${PRICING.MINIMUM_TOTAL} totaal). Voorrijden kost slechts ${PRICING.TRAVEL} in heel Zuid-Holland.` },
