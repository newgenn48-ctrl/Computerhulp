...
export const metadata: Metadata = {
  title: 'Computerhulp aan Huis Den Haag | Binnen 24u bij u Thuis',
  description: '💻 Computerhulp aan huis in Den Haag. Binnen 24 uur bij u thuis! ✓ Computer, laptop, printer, WiFi ✓ Geen voorrijkosten ✓ Transparant tarief. Bel 06-42548451.',
  openGraph: {
    title: 'Computerhulp aan Huis Den Haag | Binnen 24u bij u Thuis',
    description: 'Binnen 24 uur bij u thuis in Den Haag. Computer, laptop, printer, WiFi problemen opgelost. Geen voorrijkosten. Bel 06-42548451',
    type: 'website',
    url: 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag',
  },
  alternates: {
    canonical: 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag',
  },
}
...
const structuredData = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      audience: {
        '@type': 'Audience',
        audienceType: 'Particulieren en bedrijven in Den Haag',
        geographicArea: {
          '@type': 'City',
          name: 'Den Haag'
        }
    ...
    {
      '@type': 'WebPage',
      '@id': 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag#webpage',
      url: 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag',
      name: 'Computerhulp aan Huis Den Haag | Binnen 24 Uur | €14,50',
      description: 'Computerhulp aan huis in Den Haag. Computer, laptop, printer of WiFi problemen? Wij komen binnen 24 uur bij u thuis. Geen voorrijkosten. Bel direct: 06-42548451',
      isPartOf: {
...
const faqData = {
  '@context': 'https://schema.org',
  '@type': 'FAQPage',
  '@id': 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag#faq',
  mainEntity: [
    {
      '@type': 'Question',
      '@id': 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag#faq-wat-is',
    ...
    {
      '@type': 'Question',
      '@id': 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag#faq-snelheid',
    ...
    {
      '@type': 'Question',
      '@id': 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag#faq-prijs',
      name: 'Wat kost computerhulp aan huis in Den Haag?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Onze computerhulp aan huis kost €14,50 per kwartier met een minimum van 3 kwartier (€43,50 totaal). Er zijn geen voorrijkosten in Den Haag.'
      }
    },
    {
      '@type': 'Question',
      '@id': 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag#faq-weekend',
    ...
    {
      '@type': 'Question',
      '@id': 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag#faq-gebied',
      name: 'In welke wijken van Den Haag bieden jullie computerhulp aan huis?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We bieden computerhulp aan huis in heel Den Haag, inclusief Scheveningen, Loosduinen, Bezuidenhout, Segbroek, Laak en alle andere wijken. Overal zonder voorrijkosten.'
      }
    }
  ]
}
...
const breadcrumbData = {
  '@context': 'https://schema.org',
  '@type': 'BreadcrumbList',
  '@id': 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag#breadcrumb',
  itemListElement: [
    {
      '@type': 'ListItem',
      position: 1,
    ...
    },
    {
      ...
      name: 'Computerhulp aan Huis Den Haag',
      item: {
        '@id': 'https://computerhulpzh.nl/computerhulp-aan-huis-den-haag',
        name: 'Computerhulp aan Huis Den Haag'
      }
    }
  ]
...
export default function ComputerhulpAanHuisDenHaagPage() {
  return (
    <>
      <script
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl sm:text-2xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">
              Computer, laptop, printer of WiFi problemen in <strong className="text-white">Den Haag</strong>?
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Waarom Kiezen Voor Computerhulp aan Huis in Den Haag?
            </h2>
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              In Den Haag bieden wij professionele computerhulp aan huis. Of u nu in het centrum, Scheveningen, Loosduinen, Bezuidenhout, Segbroek of een andere wijk woont - we komen bij u langs. Binnen 24 uur na uw aanvraag staan we bij u op de stoep, ook in de avonduren en in het weekend.
            </p>
            ...
            <ul className="space-y-3 text-gray-700 mb-6">
              ...
              <li className="flex items-start gap-3">
                ...
                <span><strong>Heel Den Haag:</strong> Onze computerhulp aan huis is beschikbaar in heel Den Haag zonder voorrijkosten.</span>
              </li>
            </ul>

            <p className="text-lg text-gray-700 leading-relaxed">
              Met meer dan 10 jaar ervaring in computerhulp aan huis weten we precies hoe we uw probleem snel en effectief oplossen. Of het nu gaat om een trage computer, een printer die niet werkt, WiFi problemen of email instellen - wij helpen u graag bij u thuis in Den Haag.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Meer dan 500 tevreden klanten geholpen bij hen thuis in Den Haag
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-xl text-blue-100 mb-10">
            We komen vandaag of morgen al bij u thuis in Den Haag. Geen voorrijkosten, binnen 24 uur geholpen.
          </p>
      ...
      <NearbyCities currentCity="den-haag" pageType="computerhulp-aan-huis" />
