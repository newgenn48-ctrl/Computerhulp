...
export const metadata: Metadata = {
  ...
  description: '💻 Computerhulp aan huis in Zuid-Holland. Binnen 24u bij u thuis! ✓ Computer, laptop, printer, WiFi ✓ Geen voorrijkosten. Bel 06-42548451',
  openGraph: {
    title: 'Computerhulp aan Huis Zuid-Holland | Binnen 24u bij u Thuis',
...
const structuredData = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Professionele computerhulp aan huis in heel Zuid-Holland. We komen binnen 24 uur bij u thuis voor computer, laptop, printer, WiFi en email problemen. Geen voorrijkosten, transparante prijzen van €14,50 per kwartier.',
      url: 'https://computerhulpzh.nl/computerhulp-aan-huis',
      provider: {
        '@id': 'https://computerhulpzh.nl/#organization'
      },
    ...
    },
    {
      ...
      description: 'Computerhulp aan huis in heel Zuid-Holland. Computer, laptop, printer of WiFi problemen? Wij komen binnen 24 uur bij u thuis. Geen voorrijkosten. Bel direct: 06-42548451',
      isPartOf: {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              Snel, Professioneel, Bij U Thuis
            </h1>

            {/* Subheadline */}
            <p className="text-xl sm:text-2xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">
              Computer, laptop, printer of WiFi problemen in <strong className="text-white">Zuid-Holland</strong>?
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Waarom Kiezen Voor Computerhulp aan Huis in Zuid-Holland?
            </h2>
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              In heel Zuid-Holland bieden wij professionele computerhulp aan huis. Of u nu in Den Haag, Rotterdam, Leiden, Delft, Zoetermeer of een andere plaats woont - we komen bij u langs. Binnen 24 uur na uw aanvraag staan we bij u op de stoep, ook in de avonduren en in het weekend.
            </p>
            ...
            <ul className="space-y-3 text-gray-700 mb-6">
              ...
              <li className="flex items-start gap-3">
                ...
                <span><strong>Hele provincie:</strong> Onze computerhulp aan huis is beschikbaar in heel Zuid-Holland zonder voorrijkosten.</span>
              </li>
            </ul>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-xl text-blue-100 mb-10">
            We komen vandaag of morgen al bij u thuis in Zuid-Holland. Geen voorrijkosten, binnen 24 uur geholpen.
          </p>
